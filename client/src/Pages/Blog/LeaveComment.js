    ...
    <div className='py-4'>
        ...
        <form className="flex flex-col">
            <div className="text-area w-full md:w-3/4">
                ...
                <textarea name="" id="comment" className="form-textarea border-2 border-formFieldColor w-full h-24" placeholder='Leave a comment.' required></textarea>
            </div>
            ...
            <div className="name w-full md:w-3/4">
                ...
                <input type="text" id="name" className="form-input border-2 border-formFieldColor w-full" placeholder='Name' required />
            </div>
            ...
            <div className="email w-full md:w-3/4">
                ...
                <input type="email" name="" id="email" className="form-input border-2 border-formFieldColor w-full" placeholder='Email' required />
            </div>
